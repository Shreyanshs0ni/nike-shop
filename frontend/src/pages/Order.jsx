        ...
        {products.slice(1, 4).map((item, index) => (
          ...
          >
            ...
            <div className="flex justify-between md:w-1/2">
              ...
              <button className="cursor-pointer border border-gray-300 px-4 py-2 text-sm font-medium shadow-gray-800 transition-shadow duration-300 hover:shadow-[-3px_5px_1px]">
                Track Order
              </button>
            </div>
          </div>
